...
static const char *ng1 = "D:/Workers/Xilinx/lab05/test.v";
static int ng2[] = {0, 0};
static int ng3[] = {1, 0};

void Monitor_88_2(char *);
void Monitor_88_2(char *);


static void Monitor_88_2_Func(char *t0)
{
    char *t1;
    char *t2;
    char *t3;
...
LAB2:    xsi_set_current_line(88, ng1);
    Monitor_88_2(t0);

LAB1:    return;
}

void Monitor_88_2(char *t0)
{
    char *t1;
    char *t2;
...
LAB0:    t1 = (t0 + 4112);
    t2 = (t0 + 4624);
    xsi_vlogfile_monitor((void *)Monitor_88_2_Func, t1, t2);

LAB1:    return;
}


extern void work_m_00000000003034001770_2869584147_init()
{
	static char *pe[] = {(void *)Initial_39_0,(void *)Initial_87_1,(void *)Monitor_88_2};
	xsi_register_didat("work_m_00000000003034001770_2869584147", "isim/segment_segment_sch_tb_isim_beh.exe.sim/work/m_00000000003034001770_2869584147.didat");
